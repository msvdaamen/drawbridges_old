...
public class DrawbridgeExtendedContainer  extends Container {
    ...
    public DrawbridgeExtendedContainer(IInventory playerInventory, DrawbridgeExtendedTileEntity te) {
        this.te = te;
...
//        addSlotToContainer(new SlotItemHandler(itemHandler, this.te.CAMMOSLOT, 27, 39));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (!this.mergeItemStack(itemstack1, 0, DrawbridgeExtendedTileEntity.SIZE, false)) {
                return ItemStack.EMPTY;
            }
